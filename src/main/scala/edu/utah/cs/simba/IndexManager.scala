...
private[simba] class IndexManager extends Logging {
  ...
  private[simba] def persistIndex(simbaContext: SimbaContext,
                                indexName: String,
    ...
    val sparkContext = simbaContext.sparkContext
  ...
  private[simba] def loadIndex(simbaContext: SimbaContext, indexName: String, fileName: String): Unit = {
    val sparkContext = simbaContext.sparkContext
