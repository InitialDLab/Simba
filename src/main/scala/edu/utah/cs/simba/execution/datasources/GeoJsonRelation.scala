...
import edu.utah.cs.simba.spatial.{Point, Polygon}
...
/**
 * GeoJson format datasource support
 * only Polygon and Point object supported
 * other object will be mapped to a Point(0, 0)
 */
