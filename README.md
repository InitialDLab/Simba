...
Branch Information
------------------
`standalone` branches are opened for maintaining Simba standalone package, which aims at building Simba packages standing outside Spark SQL core. `standalone-1.6` is the current develop branch for building Simba standalone package on top of Spark 1.6.x. 
